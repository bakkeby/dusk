	...
	if (display != NULL) {
		...
		if (resm != NULL) {
			...
			if (xrdb != NULL) {
				...
				XRDB_LOAD_COLOR("dwm.wsnormfgcolor", wsnormfgcolor);
				XRDB_LOAD_COLOR("dwm.wsnormbgcolor", wsnormbgcolor);
				XRDB_LOAD_COLOR("dwm.wsnormbordercolor", wsnormbordercolor);
				XRDB_LOAD_COLOR("dwm.wsnormfloatcolor", wsnormfloatcolor);
				XRDB_LOAD_COLOR("dwm.wsselfgcolor", wsselfgcolor);
				XRDB_LOAD_COLOR("dwm.wsselbgcolor", wsselbgcolor);
				XRDB_LOAD_COLOR("dwm.wsselbordercolor", wsselbordercolor);
				XRDB_LOAD_COLOR("dwm.wsselfloatcolor", wsselfloatcolor);
